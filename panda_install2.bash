...
sudo apt-get -y install nasm libssl-dev libpcap-dev subversion curl autoconf libtool \
  ...
  libglib2.0-dev libelf-dev libwiretap-dev libwsutil-dev libpcap-dev
...
if [ ! -e "/usr/bin/sdl-config" ]
then
	sudo apt-get install libsdl1.2-dev
else
	progress "Skipping libsdl install ..."
fi
...
then
  ...
  #git clone https://github.com/lslx/panda.git
  git clone git@github.com:lslx/panda.git
  cd panda/qemu
else
